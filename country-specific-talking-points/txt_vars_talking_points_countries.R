...
# txt_unvac_stable <- "remained relatively stable between {comp_yr} and {rev_yr} at {.[[paste0(recent_col, "_lbl")]]}"
# txt_unvac_declined <- "declined {abs(pchng)}% from {.[[paste0(comparison_col, "_lbl")]]} in {comp_yr} to {.[[paste0(recent_col, "_lbl")]]} in {rev_yr}"
# txt_unvac_increased <- "increased {pchng}% from {.[[paste0(comparison_col, "_lbl")]]} in {comp_yr} to {.[[paste0(recent_col, "_lbl")]]} in {rev_yr}"
# 
# # ── DTP1 ──────────────────────────────────────────────────────────────────────
